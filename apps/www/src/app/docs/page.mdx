...
import { ToggleFoldBtnWidthSlider } from "@/components/toc/toggle-fold-btn-width-slider";
import { IndentLineWidthSlider } from "@/components/toc/indent-line-width-slider";
import { AnchorPaddingBlockSlider } from "@/components/toc/anchor-padding-block-slider";
import { AnchorPaddingInlineSlider } from "@/components/toc/anchor-padding-inline-slider";
import { AnchorBorderRadiusSlider } from "@/components/toc/anchor-border-radius-slider";
import { PaddingLeftSlider } from "@/components/toc/padding-left-slider";
import { LightBarWidthSlider } from "@/components/toc/light-bar-width-slider";
import { LightBarTipRadiusSlider } from "@/components/toc/light-bar-tip-radius-slider";
import { LightSpreadLengthSlider } from "@/components/toc/light-spread-length-slider";
import { FoldingDurationSlider } from "@/components/toc/folding-duration-slider";
import { AutoFoldSwitch } from "@/components/toc/auto-fold-switch";
import { EllipsisSwitch } from "@/components/toc/ellipsis-switch";
import { ResetButton } from "@/components/toc/reset-button";
...
__TODO__: Write on `order` arugument.
...
#### Some more sliders please!

<div className="[&>ul]:list-none [&>ul]:ml-0">

- <RelativeFontSizeSlider min={60} />
- <ToggleFoldBtnWidthSlider />
- <IndentLineGapSlider max={100} />
- <IndentLineWidthSlider />
- <AnchorPaddingBlockSlider />
- <AnchorPaddingInlineSlider />
- <AnchorBorderRadiusSlider />
- <PaddingLeftSlider />
- <LightBarWidthSlider />
- <LightBarTipRadiusSlider />
- <LightSpreadLengthSlider />
- <FoldingDurationSlider />
