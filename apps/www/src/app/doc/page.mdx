...
In my imagination fixing this design issue lead to fluid motion and it became my dream project to turn it into reality.

I also took inspiration for several things from different places on the internet:

- For the tree view design, I took inspriation from the Github's "Files" side panel.
- The idea of making font size of heading titles in TOC incrementally smaller orignally came from [gwern.net](https://gwern.net/) and then from [joshwcomeau.com](https://www.joshwcomeau.com/).
