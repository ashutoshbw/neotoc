...
Whether you want to explore an interactive demo of Neotoc or create a table of contents like that for your webpage, you've come to the right place. Enjoy!
...
<Admonition type="note" title="Note: Some requirements">
...
<div className="mt-10">
  ...
  [<SquarePenIcon className="inline w-4 h-4 mr-1" />Edit this page on Github](https://github.com/ashutoshbw/neotoc/blob/main/apps/www/src/app/learn/learn.mdx)
