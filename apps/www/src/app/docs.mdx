...
Neotoc is a tool designed to make navigating within a page a joy. On mobile, tap the bottom-right button to open the TOC. On desktop, you’ll see it right away.
