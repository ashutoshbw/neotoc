...
Welcome! On a desktop, the TOC UI is on the right. On a smartphone, tap the bottom-right button to open it. Scroll around and try it out—cool, right?

A few years ago, I had this idea in an aha moment, and it’s been in my dreams since then. I didn't have enough skills back then. A few months ago I decided to give it a shot since I hadn't seen anyone working on something like this and I also gained some experience with TypeScript and React. Note that Neotoc is not tied to React, but React knowledge helped me writing the cleanup function and to be honest, I very much wanted Neotoc to use in my React projects too. And I made it. This website is built with Next.js(I agree, it's kind a overkill for single page docs like this, but I did it to know it's possible).
...
Check out [this CodePen](https://codepen.io/ashutoshbw/pen/Jojvvbp).

If you want to try out Neotoc with the comfort of your favorite code editor and with some extra features, you can use the `create-neotoc` CLI to scaffold a Vite powered Neotoc playground. Run the following in your terminal (you'll need NodeJS installed on your system to run it):
...
```sh
npm install neotoc@0.2.2
```

You can also use CDNs like jsDelivr to fetch it. For example:

```html
<script src="https://cdn.jsdelivr.net/npm/neotoc@0.2.2/dist/index.umd.js" defer></script>
```
...
```html
<link href="https://cdn.jsdelivr.net/npm/neotoc@0.2.2/dist/base-modern.css" rel="stylesheet">
```
...
```html
<link href="https://cdn.jsdelivr.net/npm/neotoc@0.2.2/dist/colors-slate.css" rel="stylesheet">
```
