...
export const lastModified = "2025-03-19";
...
But unfortunately I haven't found anything better than `requestAnimationFrame` for the animation. The problem with it is it runs on main thread. However I haven't exeperienced any jankiness unless very long document is used like having hundreds of headings. Sometimes even though when there are no perceivable jankiness, the browser console shows performance related warnings which I've no idea how to get rid of.
