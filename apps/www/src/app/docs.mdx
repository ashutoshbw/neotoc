...
Neotoc is a tool designed to make navigating within a page a joy.  On mobile, tap the bottom-right button to open the TOC. On desktop, you’ll see it right away. If you want a TOC like this on your website—without the headache of building one from scratch—Neotoc is for you.

Its design is inspired by GitHub's file navigation tree. It's made for use in documentation and technical blogs — but you're free to use it wherever it feels right.
...
```html
<script
  src="https://cdn.jsdelivr.net/npm/neotoc@1.0.0/dist/index.umd.js"
  defer
></script>
```
...
```html
<link
  href="https://cdn.jsdelivr.net/npm/neotoc@1.0.0/dist/base-modern.css"
  rel="stylesheet"
/>
```
...
```html
<link
  href="https://cdn.jsdelivr.net/npm/neotoc@1.0.0/dist/colors-slate.css"
  rel="stylesheet"
/>
```
