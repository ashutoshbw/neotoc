...
export const lastModified = "2025-04-28";

# Neotoc

Most table of contents components on documentation sites simply highlight the current heading — usually based on some guesswork. That’s fine, but it barely scratches the surface of what’s possible.

**Neotoc goes further.**

It doesn’t just track which section you’re in — it visually mirrors how much of each section is currently in view — offering spatial awareness inside long-form content like never before.

Neotoc is a **table of contents**(TOC) **generator** library designed to make navigating within a page a joy. On mobile, tap the bottom-right button to open the TOC. On desktop, you’ll see it right away.

It's made for use in documentation and technical blogs — but you're free to use it wherever it feels right.
