...
export const lastModified = "2025-03-21";
...
The easiest way to start playing with Neotoc locally is to use the `create-neotoc` CLI. This is an interactive CLI I've created to scaffold a vite powered playground to easily experiment with neotoc. (You'll need Nodejs installed on your system to run it). Run the following on your terminal:
...
```sh
npm install neotoc@0.2.1
```

You can also use CDNs like jsDelivr to fetch it. For example:

```html
<script src="https://cdn.jsdelivr.net/npm/neotoc@0.2.1/dist/index.umd.js" defer></script>
```
...
```html
<link href="https://cdn.jsdelivr.net/npm/neotoc@0.2.1/dist/base-modern.css" rel="stylesheet">
```
...
```html
<link href="https://cdn.jsdelivr.net/npm/neotoc@0.2.1/dist/colors-slate.css" rel="stylesheet">
```
